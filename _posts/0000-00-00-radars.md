...
These enhancements uplift the BYOR functionality to match that of the [official thoughtworks radar](https://thoughtworks.com/radar) and include

- support for blip movement data (no change, moved in, moved out)
