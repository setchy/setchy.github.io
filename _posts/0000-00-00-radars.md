...
2. <span class="icon github">[setchy/build-your-own-radar@deploy/combined-enhancements](https://github.com/setchy/build-your-own-radar/tree/deploy/combined-enhancements)</span>, a hosted, customized version of the BYOR open-source project, which incorporates a number of [pending enhancements](https://github.com/thoughtworks/build-your-own-radar/pulls/setchy) which uplift the BYOR functionality to match that of the [official thoughtworks radar](https://thoughtworks.com/radar)
