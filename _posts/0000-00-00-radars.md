...
2. <span class="icon github">[setchy/build-your-own-radar@deploy/combined-enhancements](https://github.com/setchy/build-your-own-radar/tree/deploy/combined-enhancements)</span>, a hosted, customized version of the BYOR project, which incorporates a number of enhancements to address the gaps between the [byor hosted offering](https://radar.thoughtworks.com) and the [official thoughtworks radar](https://thoughtworks.com/radar)
